...
using Moq;
using Sokairyk.DynamicCode.CSharp;
using System.Reflection;

namespace Sokairyk.DynamicCode.Tests
{
...
namespace ExampleNS {
    public class ExampleClass {
        ...
        private readonly ILogger<CSharpCompilationManager> _logger = Mock.Of<ILogger<CSharpCompilationManager>>();

        [Test]
        public void InvalidCodeCompilationTest()
        {
            var cSharpLang = new CSharpCompilationManager(_logger);
