...
namespace DiskFilesManagement.FileStructureModels
{
    ...
    public abstract class BaseComposite
    {
        ...
        public BaseComposite(string fullpath, BaseComposite parent, ILogger logger, List<BaseComposite> children = null)
        {
        ...
        public void Scan(bool recursive = false)
        {
            ...
            foreach (var systemEntry in Directory.GetFileSystemEntries(FullPath))
            {
                ...
                if ((entryAttributes & FileAttributes.Directory) == FileAttributes.Directory)
                    _children.Add(new FolderItem(systemEntry, this, _logger));
                    ...
                    _children.Add(new FileItem(systemEntry, this, _logger));
                else
