...
namespace Sokairyk.AutoMapper
{
    public static class AutoMapperExtensions
    {
        internal class ManualProfile : Profile
        {
            ...
            {
                // NOTE: DefaultMemberConfig is not accesible since version 11.xx
        ...
        public static void CreateMappings<TSource, TDestination>(this IProfileExpression config, Expression<Func<TSource, TDestination>> expression)
        {
            ...
            foreach (var binding in memberInitExpression.Bindings)
            {
                ...
                var mapFromSpecificSignature = typeof(IProjectionMemberConfiguration<TSource, TDestination, object>).GetMethods()
                ...
                if (mapFromSpecificSignature == null)
                    throw new Exception(@"AutoMapper's interface IProjectionMemberConfiguration does not define a method with the following signature:
